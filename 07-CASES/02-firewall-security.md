# Case 02 — Firewall, Virtualization & Application Resilience
...
- Proof of Concept (PoC) with pfSense for a branch environment;
...
I also conducted a Proof of Concept with **pfSense** for a branch environment.
...
During predictable peak periods, the number of simultaneous requests could cause the database to become unavailable.
